...
%ctor {
    ...
    NSLog(@"[RunningDotIndicator] v1.6.12 ctor: 1.6.1 baseline + dominant-color icon mode + fix icon capture (snapshot full-size) + remove respring");
    RDLog(@"======== v1.6.12 loading (1.6.1 baseline; dominant-color icon mode; fix: snapshot full-size for icon capture; no respring button; Lynx2 wording dropped) ========");
