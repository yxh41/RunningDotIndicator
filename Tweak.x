...
static void MKArmFolderCloseGuard(void) {
    ...
    sFlashWindow = YES; sFlashStart = [NSDate date].timeIntervalSince1970; sFlashLogCount = 0; sRevealLogCount = 0;
                        ...
                        @try {
                            ...
                            for (UIWindow *w3 in wins3) {
                                ...
                                while (stk.count > 0) {
                                    ...
                                    if (ivCls3 && [cur isKindOfClass:ivCls3]) {
                                        SBIconView *iv = (SBIconView *)cur;
                                        NSString *b = MKGetCachedBid(iv);
                                        if (b.length) {
