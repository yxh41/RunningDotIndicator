...
static void MKStrayNameProbe(UIView *label) {
    ...
    @try {
        ...
        BOOL dockStray = (owner && ownerInDock && (bidMismatch || textMismatch));
        ...
        NSString *lblBid = MKLabelToBid(label);
