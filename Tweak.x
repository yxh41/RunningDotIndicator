//
//  Tweak.x — RunningDotIndicator v1.6.64
...
static void MKUpdate(SBIconView *self) {
    MKSafe(^{
        ...
        if (overlay) {
            indicatorFrame = MKIndicatorFrameInOverlay(bundleID, overlay, cfg);
        }
