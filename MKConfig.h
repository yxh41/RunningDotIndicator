...
@property (nonatomic, readonly) NSInteger  folderIndicatorMode; // 文件夹内取哪个 App 作代表: 0=位置靠前, 1=来信息最新, 默认 0
@property (nonatomic, readonly) BOOL       hideBetaDot;          // v2.0.14: 运行中指示器显示时是否隐藏 TestFlight 小黄点, 默认 NO
